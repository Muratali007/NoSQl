...
func main() {
	...
	http.HandleFunc("/comparisonCoolingHousing", Handlers.AuthMiddleware(Handlers.ComparisonCoolingHousing))
	http.HandleFunc("/comparisonHousingMb", Handlers.AuthMiddleware(Handlers.ComparisonHousingMb))
	http.HandleFunc("/comparisonHousingPower", Handlers.AuthMiddleware(Handlers.ComparisonHousingPower))
	http.HandleFunc("/comparisonHousingGpu", Handlers.AuthMiddleware(Handlers.ComparisonHousingGpu))
	http.HandleFunc("/comparisonHousingCooling", Handlers.AuthMiddleware(Handlers.ComparisonHousingCooling))
